...
That copies `claude-chappe.sh` to `~/.claude/hooks/` and registers it for five events in
...
step by step, most urgent one in front and fully visible in the upper left.
